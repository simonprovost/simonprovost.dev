const publicationsConfig = {
    ...
    posts: [
        ...
        {
            titles: [
                "Risk Adjustment for Auditing Free Flap Outcomes",
        ...
        },
        {
            titles: [
                "Technical Appendix:",
                "Validating Risk-Adjustment Models in QOMS",
            ],
            details: [
                "Tighe DF, Sassoon I, Provost S, Puglia FA, Ho MWS",
                "2023 · Co-Author · Quality & Outcomes in Oral & Maxillofacial Surgery",
            ],
        ...
        {
            titles: [
                "Machine Learning for Predicting Surgical Margins",
                "in Skin Cancer",
            ],
            details: [
